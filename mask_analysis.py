...
if __name__ == '__main__':
    ...
    for pacient in tqdm(pacients):
        ...
        # new_nifti = nib.Nifti1Image(circle_rectangle_mask, heart_segs_data.affine)
        # nib.save(new_nifti, f'{output_path}/partes_moles_FakeGated_CircleRectangleMask.nii.gz')
